<template>
    ...
    <div class="form-container">
        <form @submit.prevent="OnSubmit" class="audit-form">
            ...
            <div class="form-group">
                <label for="Foto_No_Ubicado">FOTOGRAFÍA DOMICILIO</label>
                <input type="file" id="Foto_No_Ubicado" name='Foto_No_Ubicado' accept="image/*" @change="onFileChange" class="form-input" required>
            </div>
...
const directorioNoDom = '../no_domicilio_fotos'
